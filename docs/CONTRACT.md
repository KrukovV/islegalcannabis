...
- Scenario-level production UI audits must prefer Method 2 cookie seeding after the access probe: seed `__vercel_bypass` once in one Playwright browser context and reuse that context for all audited countries, states, popups, and screenshots.
