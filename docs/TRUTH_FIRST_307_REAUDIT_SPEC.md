...
2026-08-12 UG current-record packet: 238/307 structured independent packets; 270/307 normalized independent Truth Colors; 37/307 remaining. The normalized distribution is `GREEN=89`, `YELLOW=100`, `RED=19`, `UNKNOWN=62`, and `NO_INDEPENDENT_COLOR=37`. Uganda's current Parliament PDF now records owner, direct national applicability, exact `#page=9`, `#page=17`, `#page=20`, `#page=71` and `#page=85` locators, exact cannabis/route fragments, human visual state, C1 metadata and C2 text-first retrieval in the existing ledger. The current primary PDF and commencement instrument are `NOT_MODIFIED`; the ULII consolidated-text context returned `HTTP_STATUS_403`, retained only as `ACCESS_BLOCKED` metadata. The current Act's Schedule 2 cannabis entry plus sections 4 and 7 establish a narrow statutory prescription/pharmacist-supply route, while Schedule 4 and section 11 preserve the unlicensed/recreational prohibition. It is therefore proposal-only `YELLOW`, not operational `GREEN`, `RED`, or a retrieval-driven `UNKNOWN`. Strict browser-domain acceptance remains false and cannot affect legal truth. The audit remains proposal-only; `APPLY_ALLOWED=false`, `PRODUCTION_TOUCHED=false`, `MAP_COLORS_CHANGED=false`, and `SSOT_CHANGED=false`.

Remaining canonical GEO IDs: RE, RU, SH, KN, LC, SM, SA, SN, SER, KAS, SL, SX, SB, SO, GS, SS, LK, SD, SR, SY, TJ, TZ, TH, TL, TG, TO, TT, TN, TM, TC, TV, UA, US, VI, EH, YE, ZM.
