...
2026-08-12 PG current-record packet: 237/307 structured independent packets; 269/307 normalized independent Truth Colors; 38/307 remaining. The normalized distribution is `GREEN=89`, `YELLOW=99`, `RED=19`, `UNKNOWN=62`, and `NO_INDEPENDENT_COLOR=38`. PG retains the National Parliament Act No. 26 PDF with direct `#page=7`, `#page=33`, `#page=44` and `#page=45` locators, the current National Parliament legislative card, and the official Hansard amendment-chain context. The current Parliament card identifies Act No. 26 as Passed and Certified; the primary text visibly lists cannabis/resin/oil/plants in Schedule I and says that Schedule has no medical value and is strictly prohibited, while Schedule VII visibly supplies possession and plant penalties. The two direct C1 requests returned `ACCESS_BLOCKED`/404 after redirect and remain C2/C3 routing metadata only; strict browser-domain acceptance is false, but this access state does not create the RED proposal. A prior wrong-GEO Parliament-card publication was rehomed from AT to PG with the canonical URL preserved and a builder event. The audit is proposal-only; `APPLY_ALLOWED=false`, `PRODUCTION_TOUCHED=false`, `MAP_COLORS_CHANGED=false`, and `SSOT_CHANGED=false`.

Remaining canonical GEO IDs: RE, RU, SH, KN, LC, SM, SA, SN, SER, KAS, SL, SX, SB, SO, GS, SS, LK, SD, SR, SY, TJ, TZ, TH, TL, TG, TO, TT, TN, TM, TC, TV, UG, UA, US, VI, EH, YE, ZM.
