...
- [in_progress] Execute the canonical 307-GEO Truth-First independent official-law re-audit proposal-only. The SN 2026-08-12 packet brings the canonical ledger to 249/307 structured packets; the rebuilt 307-row proposal matrix has 279/307 normalized independent colors and 28 GEO without one. SN retains two annotated official CENTIF URLs: the direct Code des Drogues PDF and the national-legislation index. The Code directly proves nationwide cannabis-plant cultivation prohibition and cannabis-oil/derivative personal-consumption penalties, but also separates Table I prohibition from Table II/III medical authorisation. C1/C2 were access-only and C3 headless captured HTTP 500 Web Page Blocked for both URLs, so no fresh cannabis table/classification or cannabis patient exception was proved. SN is proposal-only UNKNOWN with the explicit legal reason `LEGAL_APPLICABILITY_UNRESOLVED`, not a WAF-derived conclusion; no product layer changed.
...
Current progress (2026-08-12, SN current-record packet recorded): 249/307 structured independent packets; 279/307 GEO with a normalized independent Truth Color; 28/307 without an independent color. Distribution is GREEN=91, YELLOW=106, RED=19, explicit UNKNOWN=63 and no independent color=28. SN retains two annotated official CENTIF records, each with owner, SN scope, direct locator, exact fragment, annotation, visual state and C0-C3 revalidation data. The direct Code supports cannabis prohibition but its current cannabis schedule/classification and medical-authorisation applicability were unavailable after C1/C2 access failures and two current C3 HTTP 500 WAF captures. The explicit proposal-only `UNKNOWN / LEGAL_APPLICABILITY_UNRESOLVED` is a legal-chain limitation, not an inference from WAF; SSOT, map, runtime and production remain out of scope.

Remaining GEO IDs: RU, SH, SER, KAS, SL, SX, SB, SO, GS, SS, LK, SD, SR, SY, TJ, TZ, TH, TL, TG, TO, TN, TM, TC, TV, US, EH, YE, ZM.
