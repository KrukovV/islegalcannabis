...
const EXTRA_KEY = "concentrates";
const EXTRA_LABEL = "Concentrates";
...
export function generateMetadata({
  ...
  const canonical = `/are-concentrates-legal-in-${entry.slug}`;
  return {
...
export default function ConcentratesSeoPage({
  params
}: {
  params: { slug: string };
}) {
