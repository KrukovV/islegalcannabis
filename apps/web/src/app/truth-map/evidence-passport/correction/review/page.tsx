...
import { buildCorrectionReviewQueue } from "@/truth-map/correctionRequest";
...
export default async function CorrectionReviewPage() {
  ...
  return <main className={styles.page} data-testid="correction-review-page">
    ...
    <section className={styles.controls}><CorrectionReviewQueue initialQueue={buildCorrectionReviewQueue()} /></section>
