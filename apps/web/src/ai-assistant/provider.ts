...
const OLLAMA_GENERATE_TIMEOUT_MS = Number(process.env.AI_TIMEOUT || 90000);
const EXTERNAL_GENERATE_TIMEOUT_MS = 8000;
const OLLAMA_FIRST_TOKEN_TIMEOUT_MS = Number(process.env.AI_FIRST_TOKEN_TIMEOUT || 40000);
