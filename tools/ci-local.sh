...
CI_LOCAL_AUDIT_SCOPE_PATHS="${CI_LOCAL_AUDIT_SCOPE_PATHS:-.gitattributes,AGENTS.md,README.md,vercel.json,Reports/**,CONTINUITY.md,data/wiki/**,data/wiki_cache/**,data/wiki_notes/**,data/official/**,data/reviews/**,data/store_truth/**,data/b2b_evidence/**,docs/**,tools/**,apps/web/**,package.json,playwright.config.ts,tests/ui/**}"
